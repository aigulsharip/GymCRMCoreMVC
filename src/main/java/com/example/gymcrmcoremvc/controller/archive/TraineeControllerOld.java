...
@Controller
@RequestMapping("archive/trainees")
public class TraineeControllerOld {

    private final TraineeService traineeService;

    private final TrainerService trainerService;

    public TraineeControllerOld(TraineeService traineeService, TrainerService trainerService) {
