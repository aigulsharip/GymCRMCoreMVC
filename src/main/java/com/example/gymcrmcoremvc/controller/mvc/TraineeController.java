package com.example.gymcrmcoremvc.controller.mvc;
...
public class TraineeController {
    ...
    private final TraineeMVCService traineeService;

    private final TrainerMVCService trainerService;

    public TraineeController(TraineeMVCService traineeService, TrainerMVCService trainerService) {
