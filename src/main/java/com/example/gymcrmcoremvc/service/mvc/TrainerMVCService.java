...
@Service
@Slf4j
public class TrainerMVCService {

    private final TrainerRepository trainerRepository;
    private final TrainingTypeMVCService trainingTypeService;

    @PersistenceContext
    private EntityManager entityManager;

    @Autowired
    public TrainerMVCService(TrainerRepository trainerRepository, TrainingTypeMVCService trainingTypeService) {
